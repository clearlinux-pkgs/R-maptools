...
Version  : 0.9
Release  : 7
URL      : https://cran.r-project.org/src/contrib/maptools_0.9-1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/maptools_0.9-1.tar.gz
...
%build
export LANG=C
export SOURCE_DATE_EPOCH=1487949996
